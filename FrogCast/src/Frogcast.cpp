...
int main() {
	...
	ProdCast::ProdCastEngine* engine = new ProdCast::ProdCastEngine(2048, 48000, ProdCast::Backends::BE_PORTAUDIO);
	...
	ProdCast::VST::VSTEffect* effect = new ProdCast::VST::VSTEffect(engine, "C:/Program Files/Common Files/VST3/FabFilter/FabFilter Pro-C .vst3");
